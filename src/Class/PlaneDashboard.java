...
public class PlaneDashboard extends JFrame implements ActionListener {
	...
	public PlaneDashboard() {
		...
		icon2 = new ImageIcon(getClass().getResource("welcomeicon.png"));
		...
		icon = new ImageIcon(getClass().getResource("planedash.jpg"));
		...
		if (e.getSource() == jButton3) {
			...
			if (jComboBox.getSelectedIndex() == 0 && jComboBox2.getSelectedIndex() == 0) {
				...
				try {
					...
					File file = new File("D:\\AIUB\\Class Materials\\SEMESTER-2 (summer 21-22)\\OOP-1 (JAVA)\\FINAL\\PROJECT\\Ticket System\\src\\Data\\Planedata.txt");
					if (!file.exists()) {
