...
public class Register implements ActionListener {
	...
	Register() {
		...
		backButton.setBounds(520, 380, 240, 30);
        ...
        if(e.getSource() == signupr){  
        	...
        	if (fname.isEmpty() || lname.isEmpty() || uname.isEmpty() || pass.isEmpty() || cnumber.isEmpty() ||  mail.isEmpty())
        	{
        		...
        		try {
        			...
        			File file = new File ("D:/AIUB/Class Materials/SEMESTER-2 (summer 21-22)/OOP-1 (JAVA)/FINAL/PROJECT/Ticket System/src/Data/Registration.txt");
            		...
            		printWriter.println("================Self Registration=============");
